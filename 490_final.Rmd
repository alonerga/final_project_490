...
A test of fluorogenic substrate proxies and their stability at high temperatures. 
...
```{r}
raw_thermal <- ggplot(thermaldeg_data, aes(x=elapsed.time, y=RFU, colour = substrate, shape = as.factor(replicate))) + 
  geom_point() +
